...
- **Level 6 no longer validates** with the 0.83 box + the honest orbiter check: unfair bars 37, 42, 44, 67 after 10 re-roll passes (levels 2-5 pass in 3-10). Milko's call: `sweeper_gap`/`gate_opening` up on level 6, or `orbiter_pairs` off there, or accept it. Bots were run on 1-5.
